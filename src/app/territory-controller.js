...
const TERRITORY_LOCAL_STORAGE_BASES=[
  "atlas-karst-house-v06",OBSERVATION_KEY,LORE_KEY,CARTOFRICHES_KEY,HERITAGE_KEY,BSS_LOCAL_KEY,HYDROMETRY_KEY,BIODIVERSITY_KEY,
...
function resetTerritoryRuntimeData(){
  ...
  loadLocalCavities();loadLoreItems();loadCartofriches();loadHeritage();loadBssLocal();loadHydrometry();loadBiodiversity();loadEncounterCollection();updateEncounterUI();
