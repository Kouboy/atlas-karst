...
function bindNativeSidebarShell(){
  ...
  const navigation=els.sidebar.querySelector(".sidebar-section-tabs"),placements={
    carnets:["carnets"],explorer:["location","display","starting-point","legend"],noter:["field-notes","time"],sources:["source-status","heritage","cartofriches","bss","hydrometry","biodiversity","nature","land-cover","industrial-history","diagnostic"]
  };
