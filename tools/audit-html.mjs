...
check("registre central des sources", () =>
  ...
  (sourceByName["source-registry.js"].match(/statusElementId:/g)||[]).length===10 &&
...
check("architecture carnet minimaliste", () =>
  ...
  ["carnets","location","display","starting-point","legend","field-notes","source-status","hydrometry","diagnostic"].every((key)=>html.includes(`data-ui-card="${key}"`)) &&
