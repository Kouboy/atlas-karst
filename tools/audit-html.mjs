...
check("architecture carnet minimaliste", () =>
  ...
  ["carnets","location","display","starting-point","legend","field-notes","source-status","hydrometry","biodiversity","nature","diagnostic"].every((key)=>html.includes(`data-ui-card="${key}"`)) &&
